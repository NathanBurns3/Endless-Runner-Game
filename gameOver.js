class gameOver extends Phaser.Scene {
  ...
  create(data) {
    ...
    let gameOverText = this.add
      .text(game.config.width / 2, game.config.height / 2 - 150, "Game Over", {
        font: "48px Arial",
        fill: "#ffffff",
      })
      .setOrigin(0.5);
    ...
    let playAgainButton = this.add.rectangle(
      game.config.width / 2,
    ...
    let playAgainText = this.add
      .text(game.config.width / 2, game.config.height / 2 + 50, "Play Again", {
        font: "24px Arial",
        fill: "#000000",
      })
      .setOrigin(0.5);
